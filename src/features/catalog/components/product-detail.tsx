  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 md:py-12">
      ...
      <motion.div
        ...
        animate={reveal(0)}
        className="text-nova-muted mb-5 flex items-center gap-2 text-xs"
      >
      ...
      <div className="grid gap-8 lg:grid-cols-[1.02fr_.98fr]">
        ...
        >
          ...
          <motion.div
            ...
            animate={reveal(0.28)}
          >
            <div className="bg-nova-accent/10 text-nova-accent flex items-center gap-1 rounded-full px-3 py-1.5 text-sm font-bold">
          ...
          {discounted ? (
            <motion.p
              initial={{ opacity: 0, y: 10 }}
              animate={reveal(0.42)}
              className="text-nova-accent mt-1 text-sm font-bold"
            >
          ...
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={reveal(0.48)}
            className="text-nova-muted mt-6 text-sm leading-8"
          >
            {product.description}
          </motion.p>
          <motion.div
            ...
            animate={reveal(0.56)}
            className="border-nova-line bg-nova-surface mt-7 rounded-[22px] border p-4"
          >
          ...
          <motion.div
            ...
            className="bg-nova-surface mt-4 rounded-2xl p-4 text-sm"
          >
      ...
      >
        ...
        <div className="border-nova-line bg-nova-surface mt-5 rounded-3xl border p-5">
          <div className="flex items-center justify-between">
            ...
            <div className="text-nova-ink text-3xl font-black">
