...
export function HomeHero({ hero }: { hero: HeroData }) {
  ...
  return (
    <section className="nova-hero border-nova-line bg-nova-surface relative isolate overflow-hidden border-b">
      <div
      ...
      >
        ...
        <motion.div
          ...
          animate={
            mounted
              ? { opacity: 1, scale: 1, x: 0, y: 0 }
              : { opacity: 0, scale: 0.65, x: -35, y: 30 }
          }
          transition={{
        ...
        <motion.div
          ...
          animate={
            mounted ? { opacity: 1, scale: 1.15 } : { opacity: 0, scale: 0.6 }
          }
          transition={{
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-3 py-9 sm:px-4 sm:py-14 lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:gap-12 lg:py-16 xl:py-20">
        ...
        >
          <div className="nova-hero-visual relative mx-auto aspect-[1.04] w-full max-w-170">
            <motion.div
              className="nova-hero-ring border-nova-primary/15 absolute inset-[8%] rounded-full border"
            ...
            />
            <motion.div
              className="nova-hero-ring nova-hero-ring-delay border-nova-accent/15 absolute inset-[16%] rounded-full border"
              initial={{ opacity: 0, scale: 0.75, rotate: 16 }}
              animate={
                mounted
                  ? { opacity: 0.95, scale: 1, rotate: 0 }
                  : { opacity: 0, scale: 0.75, rotate: 16 }
              }
              transition={{ duration: 1.15, delay: 0.48, ease }}
            />

            <motion.div
              className="nova-hero-backdrop bg-nova-ink absolute inset-[7%] rounded-[38px] sm:rounded-[48px]"
              initial={{ opacity: 0, rotate: -10, scale: 0.9, x: 18 }}
              animate={
                mounted
                  ? { opacity: 1, rotate: -4, scale: 1, x: 0 }
                  : { opacity: 0, rotate: -10, scale: 0.9, x: 18 }
              }
              whileHover={
                reducedMotion ? undefined : { rotate: -2.5, scale: 1.015 }
              }
              transition={{ duration: 0.9, delay: 0.22, ease }}
            />

            <motion.div
              className="bg-nova-primary/12 absolute inset-[11%] overflow-hidden rounded-[31px] sm:rounded-[40px]"
              initial={{ opacity: 0, scale: 0.84 }}
              animate={
                mounted ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.84 }
              }
              ...
              <motion.div
                ...
                animate={
                  mounted && !reducedMotion
                    ? { scaleX: [0.9, 1.08, 0.9], opacity: [0.35, 0.52, 0.35] }
                    : undefined
                }
                transition={{
                  duration: 3.8,
              ...
              <motion.div
                ...
                animate={
                  mounted
                    ...
                    : { opacity: 0, y: 42, scale: 0.86, rotate: 3 }
                }
                transition={{ duration: 1.05, delay: 0.48, ease }}
                whileHover={
                  reducedMotion
                    ? undefined
                    : { y: -8, scale: 1.025, rotate: -1 }
                }
            ...
            <motion.div
              className="absolute top-[7%] left-[2%] rounded-2xl border border-white/60 bg-white/90 px-4 py-3 shadow-[0_24px_55px_-28px_rgba(17,24,39,.6)] backdrop-blur-xl"
              initial={{ opacity: 0, x: -30, y: 18, scale: 0.8 }}
              animate={
                mounted
                  ? { opacity: 1, x: 0, y: 0, scale: 1 }
                  : { opacity: 0, x: -30, y: 18, scale: 0.8 }
              }
              transition={{ duration: 0.75, delay: 0.8, ease }}
              whileHover={reducedMotion ? undefined : { y: -7, scale: 1.035 }}
            >
              <div className="flex items-center gap-2">
                <span className="bg-nova-accent/12 text-nova-accent grid size-8 place-items-center rounded-xl">
                  <Star size={15} fill="currentColor" />
                </span>
                <div>
                  <p className="text-nova-muted text-[10px] font-bold">
                    امتیاز مشتری‌ها
                  </p>
                  <p className="text-nova-ink mt-0.5 text-sm font-black">
                    {rating.toFixed(1)} / 5
                  </p>
                </div>
              </div>
            ...
            <motion.div
              ...
              animate={
                mounted
                  ? { opacity: 1, x: 0, y: 0, scale: 1 }
                  : { opacity: 0, x: 32, y: 22, scale: 0.8 }
              }
              transition={{ duration: 0.78, delay: 1.0, ease }}
              whileHover={reducedMotion ? undefined : { y: -8, scale: 1.035 }}
            >
              <div className="flex items-center gap-2.5">
                <span className="bg-nova-primary grid size-8 place-items-center rounded-xl text-white">
                  <Truck size={15} />
                </span>
                <div>
                  <p className="text-nova-muted text-[10px] font-bold">
                  ...
                  <p className="text-nova-ink mt-0.5 text-xs font-black">
                    مطمئن تا لحظه تحویل
                  </p>
                </div>
              </div>
            ...
            <motion.div
              ...
              className="absolute top-[47%] right-[4%]"
            >
              <Link
                href={href}
                className="group bg-nova-ink/90 flex items-center gap-2 rounded-full border border-white/40 px-4 py-2.5 text-[11px] font-black text-white shadow-2xl backdrop-blur-xl"
              >
                مشاهده محصول
            ...
            <motion.div
              className="bg-nova-ink/92 absolute right-[8%] bottom-[4%] left-[8%] rounded-3xl border border-white/15 p-4 text-white shadow-[0_25px_70px_-30px_rgba(0,0,0,.65)] backdrop-blur-xl sm:p-5"
        ...
        >
          <motion.div
            className="border-nova-primary/15 text-nova-primary inline-flex items-center gap-2 rounded-full border bg-white/60 px-3.5 py-2 text-[11px] font-bold shadow-sm backdrop-blur"
          ...
          >
            <motion.span
              animate={
                mounted && !reducedMotion
                  ? { rotate: [0, 14, -8, 0], scale: [1, 1.16, 0.98, 1] }
                  : undefined
              }
              transition={{
                duration: 2.2,
          ...
          <motion.p
            className="text-nova-primary mt-5 max-w-xl text-sm leading-8 sm:text-base"
            initial={{ opacity: 0, x: 26 }}
            animate={mounted ? { opacity: 1, x: 0 } : { opacity: 0, x: 26 }}
            transition={{ duration: 0.7, delay: 0.55, ease }}
          >
            محصولات منتخب، اطلاعات شفاف و تجربه‌ای که از اولین کلیک تا تحویل
            سفارش، حس یک خرید حرفه‌ای را منتقل می‌کند.
          </motion.p>
          ...
          >
            ...
            >
              <Link href="/products">
                <Button
                  size="lg"
                  className="h-13 w-full px-6 text-sm font-black sm:w-auto"
                >
